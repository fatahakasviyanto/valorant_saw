...
<div class="container-fluid bg-dark text-white">
    ...
    <div class="container">
      ...
      <div class="section1">
        ...
        <div class="col">
          <h4 class="featurette-heading"><img src="img/valorant_icon.jpg" width="30" height="30" alt=""> Add Maps</h4>
            </div>
            <hr class="featurette-divider">
            
            <form action="editProsesMaps.php" method="post" enctype="multipart/form-data">
            
            <div class="form-group">
                Title:
                <input type="text" class="form-control" name="titleMaps" value="<?= $row ['titleMaps']?>"/>
            </div>
            <div class="form-group">
                Description:
                <textarea class="form-control" rows="4" name="descMaps"><?= $row ['descMaps']?></textarea>
            </div>
            <div class="form-group">
                Image:
        ...
        <a href="adminMapsList.php" class="btn btn-danger"><i class="bi bi-x"></i> Cancel</a>
    ...
    <footer class="container-fluid py-5" style="text-align:center;margin-top:15%;">
      &copy; Fata 2021
    </footer>
</div> 
