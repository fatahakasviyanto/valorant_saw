...
endwhile;
    ...
    $no_VOP         = array_keys($total_vop_controller, max($total_vop_controller));
    $max_VOP        = max($total_vop_controller);
  ...
  <div class="container">
                ...
                <thead>
                  <tr>
                    ...
                    <th width="10%" id="age"><div align="center">Overall Score (Controller)</div></th>
                ...
                ?>
                  <tr>
                    ...
                    <td><div align="center" style="margin-top: 5px">
                      <?php  echo $total_vop_controller[$v] ?>
                    </div></td>
                  </tr>
                <?php
                }
              ...
              <?php echo "According to the calculations, the Agents that best to be a Controller is: <b>", $nama_agent[$output], "</b>, with VOP score ", $max_VOP ?>. <a href="dssexplanation.php">How's this works?</a>
