...
endwhile;
    ...
    $no_VOP         = array_keys($total_vop_initiator, max($total_vop_initiator));
    $max_VOP        = max($total_vop_initiator);
    ...
    <table class="table table-dark table-striped" width="90%" border="0" align="left" cellpadding="5" cellspacing="5" id="mytable">
                    <thead>
                      <tr>
                        ...
                        <th width="10%" id="age"><div align="center">Overall Score (Initiator)</div></th>
                    </thead>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><div align="center" style="margin-top: 5px">
                          <?php  echo $total_vop_initiator[$v] ?>
                        </div></td>
                      </tr>
                    <?php
                    }
                  ...
                  <?php echo "According to the calculations, the Agents that best to be a Initiator is: <b>", $nama_agent[$output], "</b>, with VOP score ", $max_VOP ?>. <a href="dssexplanation.php">How's this works?</a>
